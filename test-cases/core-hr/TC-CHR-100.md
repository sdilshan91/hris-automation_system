...
> **Execution 2026-07-03 (API, @test-runner):** BLOCKED — PII-audit-on-READ not exercised; audit-on-read is atypical (audit interceptor stamps writes) and would need an audit-log query — not reached this run.
