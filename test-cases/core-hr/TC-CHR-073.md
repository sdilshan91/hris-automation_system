...
> **Execution 2026-07-03 (API, @test-runner):** BLOCKED — tenant-isolated photo storage-path + cross-tenant signed-URL denial needs 2 tenants + object-storage path inspection.
