...
**stale and must be reconciled** (P0). Line anchors below are into `test-cases/TEST-FINDINGS.md`.

## ▶ Remaining work — priority order

### P0 — Ledger reconciliation + missing test suites (cheap, unblocks accurate planning)
- **Reconcile stale trackers:** `user-stories/STATUS.md` still marks US-ADM-011, US-TRN-EPIC/001/002/003, US-NTF-006 as
...
- **Author the missing test-case suites (shipped-but-untested-in-the-ledger — ZERO coverage today):**
  `test-cases/training-benefits/TC-TRN-001/002/003`, `TC-ADM-011-*` (workflow runtime), and US-NTF-006 delivery. Add
