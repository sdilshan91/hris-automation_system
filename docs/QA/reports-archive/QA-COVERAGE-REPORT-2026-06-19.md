...
All counts verified by direct grep over `docs/QA/*/TC-*.md`. AC-coverage column from `TRACEABILITY-MATRIX.md` (Coverage `100% PASS` claimed everywhere).
