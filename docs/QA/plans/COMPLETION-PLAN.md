...
| P2-1b NTF Phase 7 core-hr + jobs | P2 | EmployeeStatusService:368 (probation-end HR) + :457 (reassignment alert); DocumentExpiryNotificationJob:74; ScheduledReportJob:96 | TODO | — | after Phase 6 |
