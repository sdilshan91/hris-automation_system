...
| P2-1c NTF Phase 8 tail | P2 | **LeaveReportExportJob:70** ("your leave export is ready" → requester) + **BulkEmployeeImportService:316** (import-completion → initiator) — 2 more inline deferred-notify sites (found by the Phase 7 integration-enforcer; Explore missed them) | TODO | — | small; then US-NTF-006 delivery is truly DONE |
