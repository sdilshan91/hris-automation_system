...
type: security
status: pass
exec_note: "2026-07-03 BUG-003 fix verification (PR#119 TenantAccessGuardMiddleware): cross-tenant probe acme JWT + X-Tenant-Subdomain:techoneglobal on GET /api/v1/onboarding/templates -> 403 cross_tenant_denied; same-tenant control -> 200 own templates. Cross-tenant template read blocked."
created: 2026-06-17
---
