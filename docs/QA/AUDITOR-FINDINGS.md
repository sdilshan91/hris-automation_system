...
| 2026-07-20 | DF-46 · goal-reopen | (decision, now built) · — | The finalize/lock had no undo (originally filed DF-46). | MED | **RESOLVED (#PR-pending)** — shipped `ReopenGoalsAsync` + endpoint + FE + 9 xUnit / 7 Karma arms; decision locked (HR or finalizing manager, mandatory reason, →Acknowledged). |
