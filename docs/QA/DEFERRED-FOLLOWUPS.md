...
| DF-19 | **ISSUE-045 pool-aware carry-forward restoration** — cancel writes one general Adjusted row, not a per-pool split; needs distinct carry-forward pool modelling (blocked on US-LV-008). | [[ISSUE-045]] (A2 defer 2026-07-18) | Feature-sized; documented TODO. | L |
