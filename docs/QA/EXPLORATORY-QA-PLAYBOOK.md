...
**REPORT-ONLY** contract: findings go to `docs/QA/TEST-FINDINGS.md`; you never edit `src/`, never
...
Append to `docs/QA/TEST-FINDINGS.md` using the **existing finding schema** — do **not** invent a
