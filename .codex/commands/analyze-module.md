...
1. Read the Claude source files above, `CLAUDE.md`, `.claude/dev-instructions.md`, and `docs/Architecture/hrm_technical_document_v4.0.md`.
2. Resolve the requested module name using the module list in the Claude skill and `docs/BA/STATUS.md`.
3. Generate or update IEEE 830 / ISO/IEC/IEEE 29148 user stories under `docs/BA/{module}/`.
4. Update `docs/BA/INDEX.md` and `docs/BA/STATUS.md` only if the generated story set changes.
